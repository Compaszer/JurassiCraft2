...
public class BlockHandler {
	...
	public static void init() {
		...
		registerBlock(EmbryoCalcificationMachineBlockEntity.class, EMBRYO_CALCIFICATION_MACHINE,
		...
		registerBlock(ElectricFenceWireBlockEntity.class, "tileEntityElectricFence", LOW_SECURITY_FENCE_WIRE,
				"Low Security Fence Wire");
		...
		registerBlock(ElectricFencePoleBlockEntity.class, "tileEntityElectricPole", LOW_SECURITY_FENCE_POLE,
				"Low Security Fence Pole");
		...
		registerBlock(ElectricFenceBaseBlockEntity.class, "tileEntityElectricBase", LOW_SECURITY_FENCE_BASE,
				"Low Security Fence Base");
	...
	public static void registerBlock(Class<? extends TileEntity> tileEntity, String tileEntityName, Block block,
			String name) {
	...
	public static void registerBlock(Block block, String name) {
		if (block instanceof SubBlocksBlock)
			RegistryHandler.registerBlockWithCustomItem(block, ((SubBlocksBlock) block).getItemBlock(),
